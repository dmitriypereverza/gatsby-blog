...
export interface FilterFuncInterface {
  (filterValue: any, targetValue: any, valueWhenNotFilter?: boolean):
    | boolean
    | undefined;
}
...
interface ToolsInterface
  ...
  elementFilterFuncWithFilter: FilterFuncCarriedWithFilterInterface;
  groupFilterFuncWithFilter: FilterFuncCarriedWithFilterInterface;
