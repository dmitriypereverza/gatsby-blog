...
import { CustomSortingFunctionInterface } from "components/TableView/RecursiveTable/types";

import { DateMode, getUnixTime } from "libs/date";
...
export const getSortValueForDate = (value) =>
  moment.isMoment(value)
    ? value.isValid()
      ? value.unix()
      : 0
    : getUnixTime(value, DateMode.DATE_TIME);
